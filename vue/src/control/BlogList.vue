...
<!--         </template>-->
      ...
      <el-table-column prop="users.username" label="博客作者" width="140" align="center">
         <template slot-scope="scope">
           <el-input v-if = "scope.row.edit" class="item" v-model="scope.row.users.username" placeholder="请输入内容"></el-input>
           <div v-else class="text">{{scope.row.users.username}}</div>
         </template>
      </el-table-column>
