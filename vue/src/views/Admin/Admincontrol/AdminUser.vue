...
<div>
  ...
  <div style="margin-top: 20px;width: 1600px">
    <el-table
            :data="userData"
            stripe
            border
...
<script>
import {GetUsersInfo,LockUserById,DeleteById,FindUserByName} from "@/plugins/users";
  export default {
    name: "UserInfo",
    data(){
      return{
    ...
    methods:{
      ...
      FindUserByName(this.nameKeyword).then(resp=>{
        if (resp.code === 200) {
