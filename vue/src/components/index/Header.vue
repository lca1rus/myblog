...
<div class="home">
    <div class="content">
      <div class="stars"></div>
      <img class="bgc" src="./video/pic.jpg" width="100%" alt="" >

      <h3 class="title" style="color: bisque">欢迎来到我的个人网站</h3>
      <h3 class="titles" style="color: bisque">今天也要加油鸭</h3>
      <div class="ribbon">
    ...
    <div class="icons"  @click="scrollToMain" >
      <!-- <i class="icon-a-xiamian"></i> -->
    </div>
    <audio  id="audio" loop="loop" autoplay="autoplay" src="./video/qing.mp3" type="audio/MP3" ref='audioDom'>
      
    </audio>
    <img    id="pic" class="music_img"  @click="musicControl" width="500" src="./video/music0.jpg" alt="" />
    <!-- <button  @click='musicControl' class="music_img" width="500" >点我</button> -->
  </div>
