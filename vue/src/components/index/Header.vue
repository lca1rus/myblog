<template>
    <header ref="header">
      ...
      <div class="ribbon bk" ref="ribbon">
...
export default {
  ...
  data:{
    ...
    mounted() {
      ...
      let startingPoint
       ...
       /*  console.log(this.clientSize.clientHeight); */
			})
  ...
  methods: {
    //根据可视窗口高度，动态改变首图大小
    setHeaderHeight() {
      this.$refs.header.style.height = '800px';
    },
    //平滑滚动至正文部分
    scrollToMain() {
      window.scrollTo({
...
.bk{
  background:rgba(128, 130, 126, 0.6) !important;
}
...
.bg1{
  background-image: url(video/4.jpg);
}
.bg2{
  background-image: url(video/5.jpg);
}
.bg3{
  background-image: url(video/6.jpg);
}
